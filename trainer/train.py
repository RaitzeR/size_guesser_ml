...
parser.add_argument(
    '--data-directory',
    help='Data directory for the training data',
    required=True
)
parser.add_argument(
    '--model-file-prefix',
    help='Prefix for the model file',
    required=True
)
parser.add_argument(
    '--job-dir',
...
data_directory = arguments.pop('data_directory')
model_file_prefix = arguments.pop('model_file_prefix')
path_to_job_dir = arguments.pop('job_dir')

print "loading dataset"
print data_directory
print model_file_prefix
print path_to_job_dir
print arguments
...
net.save(model, tags, model_file_prefix, path_to_job_dir)
...
model.fit_generator(datagen.flow(X_train, Y_train, batch_size=batch_size, shuffle=True),
            ...
            epochs=nb_epoch,
            callbacks=[
                board.createTensordboardConfig(path_to_job_dir + "/logs")
            ],
            validation_data=datagen.flow(X_test, Y_test, batch_size=batch_size),
            validation_steps=X_test.shape[0] // 50,
            )
